  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg p-6 shadow-lg duration-200 outline-none sm:max-w-lg",
...
function DialogTitle({ className, ...props }) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "text-lg leading-none font-semibold text-gray-900 dark:text-white",
        className
      )}
      {...props}
    />
